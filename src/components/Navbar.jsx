...
export default function Navbar() {
  ...
  return (
    <div className="bg-white py-2 rounded-2xl shadow-md w-auto m-5 px-4">
      <ul className="flex items-center justify-around max-w-7xl mx-auto">
        {items.map((item, index) => (
        <Link to={`/${item.label.toLowerCase().replace(/\s+/g, '')}`}>
          <li key={index}>
            <button
              onClick={() => {
                setActive(index);
